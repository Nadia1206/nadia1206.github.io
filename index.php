...
<!-- Three -->
<section id="two" class="wrapper post " >
<div class="inner">
<article class="box">
<header>
...
<!-- Four -->
<section id="three" class="wrapper post " >
<div class="inner">
<article class="box">
<header>
...
<!-- five--> 
<section id="four" class="wrapper post " >
<div class="inner">
<article class="box">
<header>
...
<!--six-->
<section id="five" class="wrapper post ">
<div class="inner">
<article class="box">
<header>
...
<!--seven-->
<section id="six" class="wrapper post " >
<div class="inner">
<article class="box">
<header>
<h2>Галерея</h2>
